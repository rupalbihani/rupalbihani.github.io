           ...
           >
             ...
             >
               ...
               <p className="text-center mt-1">
                 ...
                 <span className="text-3xl mr-2">{selected.emoji}</span>

                 <span className="font-hindi text-3xl" style={{ color: "#4A2E10", fontWeight: 700 }}>

                   {selected.hindi}

                 </span>

                 <span className="font-playful text-2xl ml-2" style={{ color: "#7A1F3D" }}>
               ...
               <div className="mt-6">
                 ...
                 <label
                   ...
                   className="font-playful text-lg block mb-2"
               ...
               <div className="flex justify-center gap-3 mt-6">
                 ...
                 <button
                   ...
                   className="font-playful text-lg px-6 py-2 rounded-full transition-all hover:scale-105"
         ...
         {sent && (
           ...
           >
             ...
             <p
               ...
               className="font-hindi text-4xl md:text-5xl leading-tight"
 ...
 return (
   ...
   >
     ...
     <span
       ...
       className="font-hindi text-lg md:text-xl mt-1"
     ...
     <span
       ...
       className="font-playful text-sm md:text-base"
