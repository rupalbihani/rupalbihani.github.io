      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "arrival" && (
          ...
          >
            <motion.p
              ...
              className="italic text-xl sm:text-2xl md:text-3xl leading-relaxed"
              style={{
        ...
        {stage === "question" && (
          ...
          >
            ...
            <p
              className="font-hindi text-4xl sm:text-5xl md:text-7xl leading-tight"
              style={{
                ...TEXT_ON_SKY,
                textShadow:
            ...
            <p
              className="font-playful text-2xl sm:text-3xl md:text-4xl leading-tight"
              style={TEXT_ON_MOON}
            >
              to walk with me now,
              <br />
            ...
            <p
              className="italic text-base sm:text-lg md:text-xl leading-relaxed max-w-md px-2"
              style={{
                fontFamily: "'Fraunces', serif",
                ...TEXT_ON_MOON,
              }}
            >
              ...
              <br />
              <span
                className="font-playful text-lg sm:text-xl md:text-2xl"
                style={{ ...TEXT_ON_MOON }}
              >
            ...
            <button
              ...
              onTouchStart={start}
              onTouchEnd={end}
              className="relative rounded-full px-8 sm:px-14 py-4 sm:py-6 overflow-hidden select-none transition-transform hover:scale-105 active:scale-100 mt-2"
              style={{
            ...
            >
              <span
                className="font-playful text-lg sm:text-2xl relative z-10"
            ...
            <div className="flex flex-col items-center gap-1">
              <p className="font-playful text-base sm:text-lg" style={TEXT_ON_MOON}>
                {progress > 0 && progress < 1 ? "keep holding…" : "hold for 3 seconds"}
              </p>
              <button
                onClick={notYet}
                className="font-playful text-sm sm:text-base underline underline-offset-4 hover:opacity-100 transition-opacity mt-1"
                style={TEXT_ON_MOON}
              >
        ...
        {stage === "done" && (
          ...
          >
            <motion.p
              ...
              className="font-hindi text-4xl sm:text-5xl md:text-7xl leading-tight mb-6"
              style={{
                color: "#2C1F4A",
                fontWeight: 700,
                textShadow:
            ...
            >
              ...
              <p
                className="font-playful text-xl sm:text-2xl mt-6"
                style={TEXT_ON_MOON}
              >
                ~ Niraj 🌙
              </p>
            ...
            <motion.p
              ...
              className="mt-8 sm:mt-10 font-playful text-sm sm:text-base md:text-lg tracking-widest uppercase"
              style={{
                color: "#5B3B72",
                textShadow:
