    ...
    <div className="relative min-h-screen overflow-hidden ghibli-sky">
      ...
      <div className="relative z-10 flex flex-col items-center justify-start min-h-screen px-6 pt-24 pb-16">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-5xl w-full"
        >
          {POEMS.map((p, i) => (
        ...
        <motion.p
          ...
          className="font-playful text-base sm:text-lg md:text-xl mt-8 sm:mt-10 text-center px-4"
          style={{
            color: "#4A2E10",
            fontWeight: 700,
...
function PoemCard({ poem, index, onOpen }: {
  ...
  return (
    ...
    >
      ...
      <h3
        className="font-hindi text-xl sm:text-2xl md:text-3xl mt-1 leading-tight"
    ...
    >
      ...
      >
        ...
        <div className="text-center">
          ...
          <h3
            className="font-hindi text-3xl sm:text-4xl md:text-5xl mt-1 leading-tight"
            style={{ color: "#4A2E10", fontWeight: 700 }}
          >
            {poem.title}
          </h3>
        ...
        <div className="space-y-6">
          {stanzas.map((stanza, i) => (
            <motion.p
              ...
              className="font-hindi text-lg sm:text-xl md:text-2xl leading-relaxed whitespace-pre-line text-center"
            ...
            >
              ...
              <div className="space-y-4">
                {englishStanzas.map((s, i) => (
                  <p
                    key={i}
                    className="font-playful text-base sm:text-lg md:text-xl leading-relaxed whitespace-pre-line text-center"
                    style={{ color: "#5B3B72" }}
                  >
                    {s}
                  </p>
