   ...
   <div className="relative min-h-screen overflow-hidden ghibli-sky">
     ...
     <div className="relative z-10 flex flex-col items-center justify-start min-h-screen px-6 pt-24 pb-16">
       ...
       <motion.div
         ...
         className="grid grid-cols-2 gap-4 md:gap-8 mt-6 max-w-2xl w-full"
...
function CityClock({ name, hindi, time, accent }: {
 ...
 return (
   ...
   <div
     ...
     className="relative rounded-3xl p-5 md:p-6 text-center overflow-hidden"
   ...
   >
     ...
     <p className="font-playful text-xl md:text-2xl" style={{ color: "#5B3B1E" }}>

       {name}

     </p>

     <p className="font-hindi text-sm mt-0.5" style={{ color: "#8B5A3C" }}>
     ...
     <p
       ...
       className="text-3xl md:text-4xl mt-2 tracking-wide"
 ...
 return (
   ...
   >
     ...
     <span
       ...
       className={hindi ? "font-hindi text-xl" : "font-playful text-xl"}
